...
<link expr:href='data:blog.url' expr:hreflang='data:blog.localeUnderscoreDelimited' rel='alternate'/>
      ...
      <b:tag cond='data:widgets.Blog.first.posts[0].featuredImage' expr:content='resizeImage(data:widgets.Blog.first.posts[0].featuredImage , 1600, &quot;1:1&quot;)' name='meta' property='og:image'/>
...
<!-- Variable definitions -->
		<Variable name="keycolor" description="Main Color" type="color" default="$(main.color)" value="#e65b00"/>
    	...
    	<Variable name="body.background.color" description="Body Background Color" type="color" default="#f6f6f6"  value="#f6f6f6"/>
			...
			<Variable name="widget.background" description="Widget Background" type="color" default="#e65b00" value="#e65b00"/>
			<Variable name="widget.title.color" description="Widget Title Color" type="color" default="#ffffff" value="#ffffff"/>
			<Variable name="main.hover" description="Title Color on Hover" type="color" default="#e65b00" value="#e65b00"/>
			<Variable name="main.tag" description="Label Tag" type="color" default="#e65b00" value="#e65b00"/>
    ...
    <Group description="Top Main Menu" selector="div.top-bar">
        	<Variable name="top.bar" description="Top Background" type="color" default="#e65b00" value="#e65b00"/>
          <Variable name="top.bar.menufont" description="Top Menu Title Color" type="color" default="#ffffff" value="#ffffff"/>
          <Variable name="bb.menufont" description="Heading Title Color" type="color" default="#e65b00" value="#e65b00"/>
    </Group>
      ...
      <Variable name="mobile.bt" description="Mobile button Background" type="color" default="#e65b00" value="#e65b00"/>
    	<Variable name="menu.color" description="Slide Menu" type="color" default="#d80418" value="#d80418"/>
      <Variable name="submenu.background.color" description="SubMenu Background Color" type="color" default="#434343" value="#434343"/>
			<Variable name="menu.first.color" description="First Menu Color" type="color" default="#b58a29" value="#b58a29"/>
    ...
    <Variable name="text.font" description="Text Font" type="font" family="Open Sans" default="normal 400 14px $(family)"  value="normal 400 14px $(family)"/>
		...
		<Group description="Theme Widths" selector="body">
			<Variable name="outerContainer.width" description="Theme Body Width" type="length" default="1145px" min="900px" max="1600px" value="1145px"/>
			<Variable name="sidebar.width" description="Sidebar Width" type="length" default="320px" min="300px" max="500px" value="320px"/>
		</Group>
...
.top-bar{height:41px}
.top-bar .container{height:41px;background:$(top.bar);padding:0 10px;border-radius:0 0 5px 5px;box-shadow: -1px 7px 8px 0 rgba(0 0 0 / 0.10);}
#top-menu{float:left}
...
.pro-light-wrap,.pro-light{position:relative;float:left;width:100%;height:56px;background:$(main.menu);box-sizing:border-box;padding:0;margin:0;box-shadow:inset 0px 2px 20px 1px rgba(23 23 23 / 0.20);}
...
#foodMenu-list>li>a{position:relative;display:block;height:46px;font-size:14px;color:$(submenu.color);font-weight:600;text-transform:capitalize;line-height:46px;padding:0 10px;margin:0}
#foodMenu-list>li>a:hover{color:$(widget.background)}
#MenuFast-pro ul>li>ul{position:absolute;float:left;left:0;top:52px;width:180px;background:$(submenu.background.color);z-index:99999;visibility:hidden;opacity:0;-webkit-transform:translateY(-10px);transform:translateY(-10px);padding:0;box-shadow:0 2px 5px 0 rgba(0,0,0,0.15),0 2px 10px 0 rgba(0,0,0,0.17)}
...
#MenuFast-pro ul>li>ul>li a{position:relative;display:block;height:46px;font-size:13px;color:$(widget.title.color);line-height:46px;font-weight:400;box-sizing:border-box;padding:0 15px;margin:0;border-bottom:1px solid rgba(155,155,155,0.07)}
...
#cooks-container{display:none;position:fixed;width:100%;height:100%;top:0;left:0;bottom:0;background:$(menu.color);background:-moz-linear-gradient(90deg,$(menu.color) 0,$(menu.first.color) 100%);background:-webkit-linear-gradient(90deg,$(menu.color) 0,$(menu.first.color) 100%);background:linear-gradient(90deg,$(menu.color) 0,$(menu.first.color) 100%);overflow:auto;z-index:1010;left:0;-webkit-transform:translateX(-100%);transform:translateX(-100%);visibility:hidden;box-shadow:3px 0 7px rgba(0,0,0,0.1);-webkit-transition:all .5s cubic-bezier(.79,.14,.15,.86);-moz-transition:all .5s cubic-bezier(.79,.14,.15,.86);-o-transition:all .5s cubic-bezier(.79,.14,.15,.86);transition:all .5s cubic-bezier(.79,.14,.15,.86)}
...
.hide-food-filter{position:absolute;top:0;right:0;display:block;color:$(widget.title.color);font-size:26px;line-height:80px;text-align:center;cursor:pointer;z-index:20;padding:0 20px;-webkit-transition:transform ease-out .2s;-moz-transition:transform ease-out .2s;-ms-transition:transform ease-out .2s;-o-transition:transform ease-out .2s;transition:transform ease-out .2s;transform:rotate(0deg)}
...
.food-filter ul li a{color:$(submenu.color);padding:0 5px;display:block}
...
.food-filter>ul>li>ul>li a{font-size:13px;font-weight:600;color:$(submenu.color);background:rgba(255,255,255,0.12);padding:0 0 0 35px;border-bottom:1px solid rgba(255,255,255,0.2)}
.food-filter>ul>li>ul>li>ul>li>a{padding:0 0 0 30px}
.food-filter ul>li>.submenu-toggle:hover{color:$(menu.hover.color)}
...
.social-light ul li a{display:block;font-size:20px;color:$(main.menu);padding:0 5px}
...
.search-button{color:$(submenu.color);top:0;right:0;width:40px;height:40px;font-size:20px;text-align:center;line-height:40px;cursor:pointer;z-index:20;padding:0;margin:0;background: rgba(255 255 255 / 0.37);border-radius:10px;box-shadow:-1px 7px 8px 0 rgb(0 0 0 / 10%);transition:margin .25s ease;}
...
.MenuFastPro .featured-meta .entry-title a,.type-slider .entry-title a,.MegaNews .item0 .entry-title a,.MenuPops .entry-title a{display:block;color:$(widget.title.color)}
a.more-c:hover,.MenuPops .entry-title a:hover,.post-filter .entry-title a:hover{color:$(main.hover)}
...
a.more-c{color:#000;font-size:13px;font-weight:600;}
...
.MenuFastPro .widget>.widget-title h3,.sidebar .widget-title h3,.MenuTopFe .widget>.widget-title h3,.related-light .widget-title h3{position:relative;float:left;font-family:var(--title-font);height:32px;font-size:15px;color:$(title.color);text-transform:uppercase;font-weight:700;line-height:32px;padding:0;margin:0;}
...
.label-news,.label-news-flex{float:left;top:20px;left:10px;height:15px;z-index:5;background-color:$(main.tag);color:$(widget.title.color);font-size:12px;line-height:15px;font-weight:600;white-space:nowrap;width:auto;overflow:hidden;padding:5px 16px;border-radius:10px;}
.label-news-flex-anywhere{position:absolute;top:-8px;left:18px;float:left;height:15px;z-index:5;background-color:$(main.tag);color:$(widget.title.color);font-size:12px;line-height:15px;font-weight:600;white-space:nowrap;width:auto;overflow:hidden;padding:5px 16px;border-radius:10px;}
...
.share-light li.share-icon span{position:relative;background-color:#fff;font-size:14px;color:$(title.color);cursor:auto;margin:0 5px 0 0}
...
.food-inner li a{color:$(title.color);line-height:1.4em;display:block;overflow:hidden;transition:color .40s}
.food-inner li:hover a{color:$(main.hover)}
...
.list-label .label-count{position:relative;float:right;width:16px;height:16px;background-color:rgba(255 1 1 / 0.12);color:$(widget.background);font-size:11px;font-weight:600;text-align:center;line-height:16px}
.cloud-label li{position:relative;float:left;margin:0 5px 5px 0}
.cloud-label li a{display:block;height:26px;overflow: hidden;color:$(widget.background);font-size:12px;line-height:26px;font-weight:400;padding:0 10px;border:1px solid $(widget.background);border-radius:10px;transition:all .30s ease}
.cloud-label li a:before{content:"\f101";float:left;color:$(widget.background);font-weight:900;font-family:'Font Awesome 5 Free';font-size:12px;margin:0 4px 0 0;}
...
.backTop:before{content:'';position:absolute;top:0;left:0;right:0;bottom:0;background-color:$(main.hover);opacity:.5;transition:opacity .30s ease;border-radius:6px;}
...
body#layout:before{content:"Cooking";font-family:MONOSPACE;position:absolute;top:20px;right:20px;z-index:1;padding:6px 14px;font-size:15px;border-radius:10px;font-weight:400;color:#919191;background:#fdfdfd;border:1px solid #cac9c9 !important;}
...
body#layout .draggable-widget .widget-wrap2{border-radius:5px;background:#3363ff url(https://1.bp.blogspot.com/-hMi3I2lPKLQ/XcVHiWtl6GI/AAAAAAAAAPQ/M2XKqrvMItIH7dQdiEyH9cQ35lvkW36FgCNcBGAsYHQ/s1600/drag.png) no-repeat 4px 50%!important}
...
body#layout div#promo-ok > h4:after{content:' - Put ad code to show ads inside posts/pages'}
body#layout .mega-flex,body#layout div#ft-post .widget,body#layout div#main-ads-below .widget{float:left;width:100%;}
div#promo-footer .container{float:left;width:100%;}
body#layout .cooking-area .widget{width:25%;float:left}
body#layout .cooking-area, body#layout div#cook-flex, body#layout div#main-ads1, body#layout div#ft-post, body#layout div#main-ads-below {overflow: hidden!important;}
body#layout .show-cooks-container,body#layout .search-toggle,body#layout #nav-search{display:none}
body#layout .header-left{display:flex;}
body#layout .SuperLogo,.MenuFast-pro{width:50%;display:block;}
...
body#layout #menu-top > h4:after{content:' - Under Menu Links'}
body#layout #social-sec > h4:after{content:' - Under Social Media Links'}
body#layout #SuperLogo > h4:after{content:' - Recommended Height size 35px'}
body#layout #MenuFast-pro > h4:after{content:' - Edit menu and submenu links here'}
...
body#layout #cooking-area > h4:after{content:' - Set different categories from here'}
body#layout #cook-flex > h4:after{content:' - Set top right side author image'}
...
body#layout #upper-ad > h4:after{content:' - Only Turn On/Off this widget'}
body#layout #lower-ad > h4:after{content:' - Only Turn On/Off this widget'}
...
<b:defaultmarkups>
  ...
  <b:if cond='data:widget.sectionId not in [&quot;ft-post1&quot;]'>
 ...
 <b:defaultmarkup type='PopularPosts'>
    <b:includable id='main' var='this'>
     ...
     <b:includable id='widget-title'>
      <b:if cond='data:defaultTitle or data:title'>
  <b:if cond='data:widget.sectionId == &quot;ft-post&quot;'>
        <div class='widget-title'><h3 class='title'><data:title/></h3>
         <a class='more-c' href='/search'>
            <data:messages.showMore/></a></div>
            <b:else/>
        <div class='widget-title'><h3 class='title'><data:title/></h3></div>
        </b:if>
      </b:if>
    ...
    <b:includable id='content' var='post'>
      <div>
        ...
        <b:class expr:name='&quot;item&quot;+data:i'/>
          ...
          <img class='snip-thumbnail' expr:alt='data:post.title ? data:post.title : data:messages.noTitle' expr:src='data:post.featuredImage.isYouTube ? resizeImage(data:post.featuredImage.youtubeMaxResDefaultUrl.jsonEscaped, 72, &quot;1:1&quot;) : resizeImage(data:post.featuredImage, 72, &quot;1:1&quot;)'/>
          <b:else/>
          <img class='snip-thumbnail' expr:alt='data:post.title ? data:post.title : data:messages.noTitle' src='https://resources.blogblog.com/img/icon_delete13.gif'/>
          ...
          <b:else/>
          <b:if cond='data:widget.sectionId not in [&quot;ft-post&quot;]'>
 ...
 <!-- Header Wrapper -->
  <header id='Menu-light' itemscope='itemscope' itemtype='https://schema.org/WPHeader' role='banner'>
    <div class='pro-light-wrap'>
        ...
        <div class='container'>
          ...
          <div class='header-section'>
            ...
            <b:section class='SuperLogo' id='SuperLogo' maxwidgets='1' name='Main Logo' showaddelement='no'>
              <b:widget id='Header1' locked='true' title='Cooking (Header)' type='Header' version='2' visible='true'>
                <b:widget-settings>
                  <b:widget-setting name='displayUrl'>http://1.bp.blogspot.com/-y8ncfedejqw/YI9jMNqXkzI/AAAAAAAABbc/Z-uH3S8HfJE-xPzpzAUP2lL6kEenCrX1wCK4BGAYYCw/s1600/Cooking-Icon-Logo.png</b:widget-setting>
                ...
                <b:includable id='main' var='this'>
                 <a class='show-cooks-container' href='javascript:;'/>
                    <b:include cond='data:imagePlacement in {&quot;REPLACE&quot;, &quot;BEFORE_DESCRIPTION&quot;}' name='image'/>
                    <b:include cond='data:imagePlacement == &quot;BEHIND&quot;' name='title'/>
                </b:includable>
      ...
      <b:if cond='data:view.search.label'><h2 class='blog-title'><b:tag expr:href='data:blog.homepageUrl' name='a'><data:view.search.label/></b:tag></h2></b:if>
            ...
            <b:section class='MenuFast-pro' id='MenuFast-pro' maxwidgets='1' name='Main Menu' showaddelement='no'>
              <b:widget id='LinkList56' locked='true' title='Main Menu' type='LinkList' version='2' visible='true'>
                <b:widget-settings>
                  <b:widget-setting name='text-10'><![CDATA[<i class="fas fa-cloud-meatball"></i> Docs]]></b:widget-setting>
                  <b:widget-setting name='sorting'>NONE</b:widget-setting>
                  <b:widget-setting name='link-1'>megamenu/recent</b:widget-setting>
                  <b:widget-setting name='link-2'>#</b:widget-setting>
                  <b:widget-setting name='link-12'>https://www.pikitemplates.com/2021/05/cooking-blogger-template.html</b:widget-setting>
                  <b:widget-setting name='link-0'>/</b:widget-setting>
                  <b:widget-setting name='link-11'>/p/shortcodes.html</b:widget-setting>
                  <b:widget-setting name='link-10'>https://blogging.pikitemplates.com/2021/05/documentation-of-cooking.html</b:widget-setting>
                  ...
                  <b:widget-setting name='text-1'><![CDATA[<i class="fas fa-solar-panel"></i> Mega Menu]]></b:widget-setting>
                  <b:widget-setting name='text-0'><![CDATA[<i class="fas fa-home"></i> Home]]></b:widget-setting>
                  <b:widget-setting name='text-3'>_Featured Posts</b:widget-setting>
                  <b:widget-setting name='text-2'><![CDATA[<i class="fas fa-atom"></i> Features]]></b:widget-setting>
                  ...
                  <b:widget-setting name='text-11'><![CDATA[<i class="fas fa-link"></i> ShortCodes]]></b:widget-setting>
                  <b:widget-setting name='text-12'><![CDATA[<i class="fab fa-staylinked"></i> Download this Template]]></b:widget-setting>
                </b:widget-settings>
                <b:includable id='main'>
                  <b:include name='content'/>
                </b:includable>
              ...
              <div id='top-menu'>
                <b:section class='menu-top' id='menu-top' maxwidgets='1' name='Top Menu' showaddelement='no'>
                  <b:widget id='LinkList3' locked='true' title='Top menu' type='LinkList' version='2' visible='true'>
                    <b:widget-settings>
                      <b:widget-setting name='link-3'>https://blogging.pikitemplates.com/2021/05/documentation-of-cooking.html</b:widget-setting>
                      <b:widget-setting name='sorting'>NONE</b:widget-setting>
                      <b:widget-setting name='text-1'><![CDATA[<i class="fas fa-trophy"></i> Popular]]></b:widget-setting>
                      <b:widget-setting name='link-1'>https://www.pikitemplates.com/?m=1</b:widget-setting>
                      <b:widget-setting name='text-0'><![CDATA[<i class="fas fa-history"></i> Latest]]></b:widget-setting>
                      <b:widget-setting name='link-2'>https://www.pikitemplates.com/?m=1</b:widget-setting>
                      <b:widget-setting name='text-3'><![CDATA[<i class="fas fa-upload"></i> Upload ]]></b:widget-setting>
                      <b:widget-setting name='link-0'>https://www.pikitemplates.com/?m=1</b:widget-setting>
                      <b:widget-setting name='text-2'><![CDATA[<i class="fab fa-gratipay"></i> Loved]]></b:widget-setting>
                    </b:widget-settings>
                    <b:includable id='main'>
              <b:include name='content'/>
            </b:includable>
                ...
                <b:section class='social-sec' id='social-sec' maxwidgets='1' name='Top Social icons' showaddelement='no'>
                  <b:widget id='LinkList4' locked='true' title='top social' type='LinkList' version='2' visible='true'>
                    <b:widget-settings>
                      ...
                      <b:widget-setting name='sorting'>NONE</b:widget-setting>
                      <b:widget-setting name='link-4'>https://www.instagram.com/pikitemplates.com/</b:widget-setting>
  ...
  <div class='clearfix'/>
    ...
    <div class='mega-flex'>
     <b:section class='cooking-area' id='cooking-area' maxwidgets='5' name='Category Labels' showaddelement='no'>
       <b:widget id='Image1' locked='true' title='Veg Plate Recipe' type='Image' version='2' visible='true'>
         <b:widget-settings>
           <b:widget-setting name='displayUrl'>http://1.bp.blogspot.com/-xjhsPrNOstk/YI-eX0AQUmI/AAAAAAAABb0/EZaTTzxDq_4xFg2ChL_uRUGuoW0D1e4qQCK4BGAYYCw/s1600/Cooking-Icon-12.png</b:widget-setting>
       ...
       <b:widget id='Image2' locked='true' title='Bread Toast Recipe' type='Image' version='2' visible='true'>
         <b:widget-settings>
           <b:widget-setting name='displayUrl'>http://2.bp.blogspot.com/-3CiRgleNQiQ/YI-emzLtwgI/AAAAAAAABb8/ktZcfRH8Y-URGTuNNnOsrxt_GFVcrmGZgCK4BGAYYCw/s1600/Cooking-Icon-11.png</b:widget-setting>
           <b:widget-setting name='displayHeight'>100</b:widget-setting>
           <b:widget-setting name='sectionWidth'>150</b:widget-setting>
           <b:widget-setting name='shrinkToFit'>false</b:widget-setting>
           <b:widget-setting name='displayWidth'>100</b:widget-setting>
       ...
       <b:widget id='Image3' locked='true' title='Strawberry Shake' type='Image' version='2' visible='true'>
         <b:widget-settings>
           <b:widget-setting name='displayUrl'>http://1.bp.blogspot.com/-RK4K8AGReE0/YI-euQuSDmI/AAAAAAAABcI/aHk6ARijYvsPU_Dezy7XDyQrH47TEE-twCK4BGAYYCw/s1600/Untitled-1.png</b:widget-setting>
           <b:widget-setting name='displayHeight'>100</b:widget-setting>
           <b:widget-setting name='sectionWidth'>150</b:widget-setting>
           <b:widget-setting name='shrinkToFit'>false</b:widget-setting>
           <b:widget-setting name='displayWidth'>100</b:widget-setting>
       ...
       <b:widget id='Image4' locked='true' title='Sweet Jelly Recipe' type='Image' version='2' visible='true'>
         <b:widget-settings>
           <b:widget-setting name='displayUrl'>http://2.bp.blogspot.com/-BxvJciEJ1pM/YI-e2zPBvWI/AAAAAAAABcU/dN8-pCPE8_IWqn3QmDX5lsKMBlT5WJ11gCK4BGAYYCw/s1600/Cooking-Icon-10.png</b:widget-setting>
           <b:widget-setting name='displayHeight'>100</b:widget-setting>
           <b:widget-setting name='sectionWidth'>150</b:widget-setting>
           <b:widget-setting name='shrinkToFit'>false</b:widget-setting>
           <b:widget-setting name='displayWidth'>100</b:widget-setting>
           <b:widget-setting name='link'>/search/label/Prisma%20Theory</b:widget-setting>
           <b:widget-setting name='caption'>Toast Bread, Cream, Choco etc.</b:widget-setting>
         </b:widget-settings>
         <b:includable id='main' var='this'>
            <b:include name='content'/>
          </b:includable>
       ...
       <b:widget id='Image5' locked='true' title='Donuts Recipe' type='Image' version='2' visible='true'>
         <b:widget-settings>
           <b:widget-setting name='displayUrl'>http://1.bp.blogspot.com/-yf4_hvYrJFk/YI-fAdVmlTI/AAAAAAAABcc/SXL-nx44b8ooJ7ffYn0cLnBOcL9vsCD0QCK4BGAYYCw/s1600/Cooking-Icon-9.png</b:widget-setting>
           <b:widget-setting name='displayHeight'>100</b:widget-setting>
           <b:widget-setting name='sectionWidth'>150</b:widget-setting>
           <b:widget-setting name='shrinkToFit'>false</b:widget-setting>
           <b:widget-setting name='displayWidth'>100</b:widget-setting>
           <b:widget-setting name='link'>/search/label/Prisma%20Theory</b:widget-setting>
           <b:widget-setting name='caption'>Double Brown Bread etc</b:widget-setting>
         </b:widget-settings>
         <b:includable id='main' var='this'>
            <b:include name='content'/>
          </b:includable>
       ...
       <b:widget id='Image6' locked='true' title='Eggs Pasta Recipe' type='Image' version='2' visible='true'>
         <b:widget-settings>
           <b:widget-setting name='displayUrl'>http://3.bp.blogspot.com/-9OuPv7TMqOE/YI-fHtwPvDI/AAAAAAAABco/TQRDoA___fQo92CDMrPtrYNyz_JlYohSwCK4BGAYYCw/s1600/Cooking-Icon-8.png</b:widget-setting>
           <b:widget-setting name='displayHeight'>100</b:widget-setting>
           <b:widget-setting name='sectionWidth'>150</b:widget-setting>
           <b:widget-setting name='shrinkToFit'>false</b:widget-setting>
           <b:widget-setting name='displayWidth'>100</b:widget-setting>
       ...
       <b:widget id='Image7' locked='true' title='Choco Pizza Recipe' type='Image' version='2' visible='true'>
         <b:widget-settings>
           <b:widget-setting name='displayUrl'>http://4.bp.blogspot.com/-_Xw5ik6aW8M/YI-fSnZkgXI/AAAAAAAABc0/C_WZasM8VJg03gDLMVXQ2619PKlMvsK4QCK4BGAYYCw/s1600/Cooking-Icon-7.png</b:widget-setting>
           <b:widget-setting name='displayHeight'>100</b:widget-setting>
           <b:widget-setting name='sectionWidth'>150</b:widget-setting>
           <b:widget-setting name='shrinkToFit'>false</b:widget-setting>
           <b:widget-setting name='displayWidth'>100</b:widget-setting>
           <b:widget-setting name='link'>/search/label/Prisma%20Theory</b:widget-setting>
           <b:widget-setting name='caption'>Chocolate, Vannila Bread etc</b:widget-setting>
         </b:widget-settings>
         <b:includable id='main' var='this'>
            <b:include name='content'/>
          </b:includable>
       ...
       <b:widget id='Image8' locked='true' title='Butter Bread Recipe' type='Image' version='2' visible='true'>
         <b:widget-settings>
           <b:widget-setting name='displayUrl'>http://1.bp.blogspot.com/-8-_2nRDfsGI/YI-fdVum4cI/AAAAAAAABc8/e52Iort9K_86b3-lxgPQVHHI-P2JRadxwCK4BGAYYCw/s1600/Cooking-Icon-6.png</b:widget-setting>
           <b:widget-setting name='displayHeight'>100</b:widget-setting>
           <b:widget-setting name='sectionWidth'>150</b:widget-setting>
           <b:widget-setting name='shrinkToFit'>false</b:widget-setting>
           <b:widget-setting name='displayWidth'>100</b:widget-setting>
           <b:widget-setting name='link'>/search/label/Prisma%20Theory</b:widget-setting>
           <b:widget-setting name='caption'>Fresh Breads, Butter, Chesse etc</b:widget-setting>
         </b:widget-settings>
         <b:includable id='main' var='this'>
            <b:include name='content'/>
          </b:includable>
       ...
       <b:widget id='Image9' locked='true' title='Creamy Starwberry Recipe' type='Image' version='2' visible='true'>
         <b:widget-settings>
           <b:widget-setting name='displayUrl'>http://3.bp.blogspot.com/-lDr6u102pYo/YI-fsML5guI/AAAAAAAABdI/BEMoUJltyFERtbT9MUSRtyNFHjqwWfmlACK4BGAYYCw/s1600/Cooking-Icon-5.png</b:widget-setting>
           <b:widget-setting name='displayHeight'>100</b:widget-setting>
           <b:widget-setting name='sectionWidth'>150</b:widget-setting>
           <b:widget-setting name='shrinkToFit'>false</b:widget-setting>
           <b:widget-setting name='displayWidth'>100</b:widget-setting>
           <b:widget-setting name='link'>/search/label/Prisma%20Theory</b:widget-setting>
           <b:widget-setting name='caption'>Strawberry, Milk Cream etc</b:widget-setting>
         </b:widget-settings>
         <b:includable id='main' var='this'>
            <b:include name='content'/>
          </b:includable>
       ...
       <b:widget id='Image10' locked='true' title='Dora Cakes Recipe' type='Image' version='2' visible='true'>
         <b:widget-settings>
           <b:widget-setting name='displayUrl'>http://3.bp.blogspot.com/-Y8_Op18rYYM/YI-f1kQrhSI/AAAAAAAABdU/Msap5OCNd8wgu7scR10qOlBAcB20gWxeQCK4BGAYYCw/s1600/Cooking-Icon-2.png</b:widget-setting>
           <b:widget-setting name='displayHeight'>100</b:widget-setting>
           <b:widget-setting name='sectionWidth'>150</b:widget-setting>
           <b:widget-setting name='shrinkToFit'>false</b:widget-setting>
           <b:widget-setting name='displayWidth'>100</b:widget-setting>
       ...
       <b:widget id='Image11' locked='true' title='Cookies Coffee Recipe' type='Image' version='2' visible='true'>
         <b:widget-settings>
           <b:widget-setting name='displayUrl'>http://1.bp.blogspot.com/-e49TOiNNIt8/YI-f_5VgyYI/AAAAAAAABdg/YAa0ywUxaE4a8T0j3vwq6fL_p3BF4Dy_ACK4BGAYYCw/s1600/Cooking-Icon.png</b:widget-setting>
           <b:widget-setting name='displayHeight'>100</b:widget-setting>
           <b:widget-setting name='sectionWidth'>150</b:widget-setting>
           <b:widget-setting name='shrinkToFit'>false</b:widget-setting>
           <b:widget-setting name='displayWidth'>100</b:widget-setting>
       ...
       <b:widget id='Image12' locked='true' title='Brown Bread Recipe' type='Image' version='2' visible='true'>
         <b:widget-settings>
           <b:widget-setting name='displayUrl'>http://2.bp.blogspot.com/-_Gms8BLQ-ow/YI-gqEXoI7I/AAAAAAAABdw/aI_HXQP-qtone-rMk_XCjJ6S7itUETyNACK4BGAYYCw/s1600/Cooking-Icon-16.png</b:widget-setting>
           <b:widget-setting name='displayHeight'>100</b:widget-setting>
           <b:widget-setting name='sectionWidth'>150</b:widget-setting>
           <b:widget-setting name='shrinkToFit'>false</b:widget-setting>
           <b:widget-setting name='displayWidth'>100</b:widget-setting>
      ...
      <b:section class='cook-flex' id='cook-flex' maxwidgets='5' name='Author Image' showaddelement='no'>
        <b:widget id='Image13' locked='true' title='Learn Cooking Recipe with me...!' type='Image' version='2' visible='true'>
          <b:widget-settings>
            <b:widget-setting name='displayUrl'>http://2.bp.blogspot.com/-4ezjmWARc8k/YI_O892tAII/AAAAAAAABeI/xr0sSo1UsbUisx5-aeAbEFv__qfLhKizQCK4BGAYYCw/s1600/Piki-Cooking-Boy.png</b:widget-setting>
            <b:widget-setting name='displayHeight'>500</b:widget-setting>
            <b:widget-setting name='sectionWidth'>150</b:widget-setting>
            <b:widget-setting name='shrinkToFit'>false</b:widget-setting>
            <b:widget-setting name='displayWidth'>519</b:widget-setting>
            <b:widget-setting name='link'>/search/label/Prisma%20Theory</b:widget-setting>
            <b:widget-setting name='caption'>Easy and Simple Procedure are provided here.</b:widget-setting>
          </b:widget-settings>
          <b:includable id='main' var='this'>
            <b:include name='content'/>
          </b:includable>
          <b:includable id='content'>
                  ...
                  <b:if cond='data:caption'>
                  <span class='flex-caption'><data:caption/></span>
                </b:if>
                </b:includable>
        </b:widget>
      </b:section>
        ...
        <div class='clearfix'/>
          ...
          <b:section class='main-ads-pikihome' id='main-ads1' maxwidgets='2' name='Ads Placement' showaddelement='yes'>
            <b:widget id='HTML14' locked='false' title='' type='HTML' version='2' visible='true'>
              <b:widget-settings>
  ...
  <div id='center-container'>
    <div class='container outer-container'>
      ...
      <main id='feed-view'>
      <b:if cond='data:view.isHomepage'>
      <b:section class='MenuFastPro flex' id='ft-post' maxwidgets='1' name='Top Feature Section' showaddelement='yes'>
        <b:widget id='PopularPosts4' locked='false' title='Featured Section' type='PopularPosts' version='2' visible='true'>
          <b:widget-settings>
        ...
        <b:section class='main' id='main' maxwidgets='1' name='Main Recent Posts' showaddelement='yes'>
          <b:widget id='Blog1' locked='true' title='Blog Posts' type='Blog' version='2' visible='true'>
            <b:widget-settings>
              ...
              <b:widget-setting name='style.urlcolor'>#e65b00</b:widget-setting>
            ...
            <b:includable id='main' var='this'>
              ...
              <div class='blog-posts hfeed container'>
                ...
                <b:if cond='data:view.isHomepage'>
                  <div class='main-title'><h3 class='title'><span><data:blog.jumpLinkMessage/></span></h3><a class='view-all' href='/search'><data:messages.showMore/></a></div>
                </b:if>
              ...
              <div class='about-author'>
                <div class='avatar-container'>
                  <b:if cond='data:post.author.authorPhoto.image'>
                     <img class='author-avatar snip-thumbnail' expr:alt='data:post.author.name' expr:src='data:post.author.authorPhoto.image ? resizeImage(data:post.author.authorPhoto.image, 200, &quot;1:1&quot;) : &quot;https://4.bp.blogspot.com/-uCjYgVFIh70/VuOLn-mL7PI/AAAAAAAADUs/Kcu9wJbv790hIo83rI_s7lLW3zkLY01EA/s100/avatar.png&quot;'/>               <b:else/>
                ...
                <ul class='description-links social-footer'/>
              </div> </div>
            </b:includable>
  ...
  <b:loop values='data:regionItems' var='byline'>
    <b:include data='byline' name='bylineByName'/>
            ...
            <b:includable id='commentFormIframeSrc' var='post'>
              <a expr:href='data:post.commentFormIframeSrc + &quot;&amp;skin=contempo&quot;' rel="nofollow noopener" title="Comment Form Link" id="comment-editor-src"/>
            </b:includable>
           ...
           <b:if cond='data:view.isMultipleItems'>
            ...
            <b:include data='post' name='postAuthorImage'/>
             ...
             <b:include data='post' name='postTimestamp'/>
              <b:if cond='!data:view.isPage and data:post.allowComments'>
  ...
  <a expr:href='data:post.manageCommentsUrl' expr:onclick='data:post.manageCommentsUrlOnclick'>
    <b:message name='messages.manageComments'/>
        ...
        noTitle: &quot;<data:messages.noTitle/>&quot;,
            ...
            <b:if cond='!data:view.isPage and data:allBylineItems.author'>
              <!-- Post Author -->
            ...
            <b:includable id='postAuthorImage' var='post'>
             ...
             <span class='author-image'><img class='snip-thumbnail' expr:src='data:post.author.authorPhoto.image ? resizeImage(data:post.author.authorPhoto.image, 72, &quot;1:1&quot;) : &quot;https://4.bp.blogspot.com/-uCjYgVFIh70/VuOLn-mL7PI/AAAAAAAADUs/Kcu9wJbv790hIo83rI_s7lLW3zkLY01EA/s100/avatar.png&quot;'/></span>
                  </b:if>
           </b:includable>
         ...
         <article class='blog-post hentry' itemscope='itemscope' itemtype='https://schema.org/CreativeWork'>
            ...
            <b:includable id='postFeaturedImage' var='post'>
              ...
              <div class='post-filter-image' itemprop='image' itemscope='itemscope' itemtype='https://schema.org/ImageObject'>
                <a class='post-filter-link' expr:href='data:post.url'>
                  <b:if cond='data:post.featuredImage'>
                  <img class='snip-thumbnail' expr:alt='data:post.title ? data:post.title : data:messages.noTitle' expr:src='data:post.featuredImage.isYouTube ? resizeImage(data:post.featuredImage.youtubeMaxResDefaultUrl.jsonEscaped, 72, &quot;1:1&quot;) : resizeImage(data:post.featuredImage, 72, &quot;1:1&quot;)' itemprop='url'/>
                    <b:else/>
                    <img class='snip-thumbnail' expr:alt='data:post.title ? data:post.title : data:messages.noTitle' src='https://resources.blogblog.com/img/icon_delete13.gif'/>
                  </b:if><b:class expr:name='data:post.featuredImage.isYouTube ? &quot;video-nos&quot; : &quot;image-nos&quot;'/>
                </a>
 ...
 &quot;publisher&quot;: {
                ...
                <li class='post-next'>
                  <b:if cond='data:newerPageUrl'>
                    <a class='next-post-link' expr:href='data:newerPageUrl' expr:id='data:widget.instanceId + &quot;_blog-pager-newer-link&quot;' rel='next'>
                      <div class='food-inner-inner'><span><data:messages.newer/></span><p/></div>
                    </a>
                    <b:else/>
                    <a rel='next'><div class='food-inner-inner post-foodMenu-open'><span><data:messages.newer/></span><p><b:eval expr='data:post.title ? data:post.title : data:messages.noTitle'/></p></div></a>
                  </b:if>
                </li>
                <li class='post-prev'>
                  <b:if cond='data:olderPageUrl'>
                    <a class='prev-post-link' expr:href='data:olderPageUrl' expr:id='data:widget.instanceId + &quot;_blog-pager-older-link&quot;' rel='previous'>
                      <div class='food-inner-inner'><span><data:messages.older/></span><p/></div>
                    </a>
                    <b:else/>
                    <a rel='previous'><div class='food-inner-inner post-foodMenu-open'><span><data:messages.older/></span><p><b:eval expr='data:post.title ? data:post.title : data:messages.noTitle'/></p></div></a>
                  </b:if>
                </li>
              </ul>
            </b:includable>
  ...
  <div class='blog-pager container' id='blog-pager'>
    ...
    <b:include cond='data:view.url != data:blog.homepageUrl' name='homePageLink'/>
            ...
            <b:includable id='postRelated' var='post'>
              ...
              <div class='related-light'>
                <div class='widget-title'>
                  ...
                  <b:if cond='data:post.labels'>
                    <a class='more-c' expr:href='data:post.labels.first.url'>
            ...
            <b:includable id='postShareButtons' var='post'>
              ...
              <div class='feed-share'>
                <ul class='share-light social-footer social-bg'>
                  ...
                  <li class='twitter'><a class='twitter window-piki' data-height='460' data-width='550' expr:data-url='&quot;https://x.com/intent/post?url=&quot; + data:post.url.canonical' href='javascript:;' rel='nofollow' title='Twitter'/></li>
                  ...
                  <li class='show-hid'><a href='javascript:;' rel='nofollow' aria-label='Share button'/></li>
                </ul>
              </div>
              </b:if>
            </b:includable>
          ...
          <b:section cond='data:view.isPost' id='upper-ad' maxwidgets='1' name='Show Top Ad' showaddelement='no'>
            <b:widget id='HTML8' locked='true' title='Top Post Ad' type='HTML' visible='true'>
              <b:widget-settings>
                <b:widget-setting name='content'><![CDATA[<a class='piki-ads' href="javascript:;">Top Post Responsive Ads code (Google Ads)</a>]]></b:widget-setting>
              </b:widget-settings>
              <b:includable id='main'>
  <b:include name='widget-title'/>
  <div class='widget-content'>
    <data:content/>
          ...
          <b:section cond='data:view.isPost' id='lower-ad' maxwidgets='1' name='Show Bottom Ad' showaddelement='no'>
            <b:widget id='HTML9' locked='true' title='Bottom Post Ad' type='HTML' visible='true'>
              <b:widget-settings>
  ...
  <div class='widget-content'>
    <data:content/>
        ...
        <b:section class='main-ads-pikihome' id='main-ads-below' maxwidgets='2' name='Ads Placement' showaddelement='yes'>
          <b:widget id='HTML7' locked='true' title='' type='HTML' visible='true'>
            <b:widget-settings>
              <b:widget-setting name='content'><![CDATA[<a class='piki-ads' href="javascript:;">Your Responsive Ads code (Google Ads)</a>]]></b:widget-setting>
            </b:widget-settings>
            <b:includable id='main'>
      ...
      <div id='sidebar-container' itemscope='itemscope' itemtype='https://schema.org/WPSideBar'>
        <b:section class='sidebar widget-control' id='sidebar1' name='Sidebar Right (A)' showaddelement='yes'>
          <b:widget id='HTML1' locked='false' title='' type='HTML' visible='true'>
            <b:widget-settings>
              <b:widget-setting name='content'><![CDATA[<a class='piki-ads-res' href="javascript:;">Your Responsive Ads Code (Google Ads)</a>]]></b:widget-setting>
            </b:widget-settings>
            <b:includable id='main'>
  <b:include name='widget-title'/>
  <div class='widget-content'>
 ...
 <div id='promo-footer'>
  <div class='container outer-container'>
    <!-- Center Featured Posts -->
        <b:section class='MenuTopFe' id='top-NewsPro-main-widget-2' maxwidgets='1' name='Fresh Posts Section' showaddelement='no'>
  ...
  <div class='container outer-container'>
      <b:section class='NewsFooter' id='NewsFooter' maxwidgets='2' name='Footer Info' showaddelement='yes'>
        <b:widget id='Image150' locked='true' title='About Us' type='Image' version='2' visible='true'>
          <b:widget-settings>
            <b:widget-setting name='displayUrl'>http://1.bp.blogspot.com/-Zi6Xk9ijXE0/YI9jPDFbcyI/AAAAAAAABbk/pfo9i00QeuM9AshsHoagod4vCV2Ls9TygCK4BGAYYCw/s1600/Cooking-Icon-Logo.png</b:widget-setting>
            <b:widget-setting name='displayHeight'>67</b:widget-setting>
            <b:widget-setting name='sectionWidth'>150</b:widget-setting>
            <b:widget-setting name='shrinkToFit'>false</b:widget-setting>
            <b:widget-setting name='displayWidth'>294</b:widget-setting>
            <b:widget-setting name='link'>/</b:widget-setting>
            <b:widget-setting name='caption'>Cooking Template is Designed Theme for Giving Enhanced look Various Features are available Which is designed in User friendly to handle by Piki Developers. Simple and elegant themes for making it more comfortable</b:widget-setting>
          </b:widget-settings>
          <b:includable id='main' var='this'>
            <b:include name='content'/>
          </b:includable>
   ...
   <div id='footer-container'>
      ...
      <b:section class='footer-copyright' id='footer-copyright' maxwidgets='1' name='Footer Attribution' showaddelement='no'>
        <b:widget id='HTML33' locked='true' title='Footer Copyright' type='HTML' visible='true'>
          <b:widget-settings>
            <b:widget-setting name='content'><![CDATA[<span class='copyright-text widget'>All Right Reserved Copyright &#169;</span>]]></b:widget-setting>
          </b:widget-settings>
          <b:includable id='main'>
  <b:include name='widget-title'/>
  <div class='widget-content'>
